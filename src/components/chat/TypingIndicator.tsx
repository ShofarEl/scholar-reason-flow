...
export const TypingIndicator: React.FC<TypingIndicatorProps> = ({
  ...
  return (
    <div className={cn("flex gap-3 mb-6 animate-fade-in", className)}>
      ...
      <div className={cn(
        "flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-1000",
      ...
      <div className="flex-1">
        ...
        {activeModel && (
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className={cn(
              "h-2 w-2 rounded-full animate-pulse transition-colors duration-1000",
              currentStageData.color
            )} />
          </div>
        )}
