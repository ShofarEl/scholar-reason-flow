        ...
        components={{
          ...
          h1: ({ children, ...props }) => {
            ...
            return (
              <h1 
                id={id}
                className="group text-3xl font-bold mb-6 mt-8 text-foreground border-b border-border pb-2 hover:border-primary/50 transition-colors scroll-mt-16"
                {...props}
              >
                <a href={`#${id}`} className="opacity-0 group-hover:opacity-100 transition-opacity mr-2 text-primary hover:text-primary/80">
                  #
                </a>
                {children}
              </h1>
          ...
          h2: ({ children, ...props }) => {
            ...
            return (
              <h2 
                id={id}
                className="group text-2xl font-semibold mb-4 mt-6 text-foreground border-b border-border pb-1 hover:border-primary/50 transition-colors scroll-mt-16"
                {...props}
              >
                <a href={`#${id}`} className="opacity-0 group-hover:opacity-100 transition-opacity mr-2 text-primary hover:text-primary/80">
                  #
          ...
          h3: ({ children, ...props }) => {
            ...
            return (
              <h3 
                id={id}
                className="group text-xl font-semibold mb-3 mt-5 text-foreground scroll-mt-16"
                {...props}
              >
                <a href={`#${id}`} className="opacity-0 group-hover:opacity-100 transition-opacity mr-2 text-primary hover:text-primary/80">
                  #
