	...
	theme: {
		...
		extend: {
			colors: {
				...
				'chat-bubble-ai-border': 'hsl(var(--chat-bubble-ai-border))',
				'chat-input': 'hsl(var(--chat-input))',
				'chat-input-border': 'hsl(var(--chat-input-border))',
				'chat-input-focus': 'hsl(var(--chat-input-focus))',
			...
			backgroundImage: {
				...
				'gradient-scholar': 'var(--gradient-scholar)',
				'gradient-reason': 'var(--gradient-reason)',
